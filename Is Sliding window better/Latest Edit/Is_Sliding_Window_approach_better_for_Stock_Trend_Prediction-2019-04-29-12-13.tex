...
\begin{document}
\pdfbookmark[title]{Is Sliding Window approach better for Stock Trend Prediction?}{title}
...
\ignorespaces 
\centering 
\begin{tabulary}{\linewidth}{p{\dimexpr.5662\linewidth-2\tabcolsep}p{\dimexpr.4338\linewidth-2\tabcolsep}}
\hline 
Parameter & Value\\
\tblmidrule 
Input &
